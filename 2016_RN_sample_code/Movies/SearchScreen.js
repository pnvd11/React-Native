 ...
 */
var API_URL = 'https://api.myjson.com/bins/ycuv9';//'https://raw.githubusercontent.com/facebook/react-native/master/docs/MoviesExample.json';//'https://drive.google.com/file/d/0B45G1DIjTg1iZU5aUXJsWlEtSUE/view?usp=sharing';//'127.0.0.1/test.json';//'http://api.rottentomatoes.com/api/public/v1.0/';
var API_KEYS = [
